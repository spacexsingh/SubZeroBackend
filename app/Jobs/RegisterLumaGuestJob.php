...
class RegisterLumaGuestJob implements ShouldQueue
{
    ...
    protected function createLumaGuest(int $lumaEventId, int $userId, string $guestApiId, array $guestInfo, array $rawData): LumaGuest
    {
        return LumaGuest::create([
            ...
            'user_name' => $guestInfo['name'] ?? $guestInfo['user_name'] ?? '',
            'user_first_name' => $guestInfo['first_name'] ?? $guestInfo['user_first_name'] ?? '',
            'user_last_name' => $guestInfo['last_name'] ?? $guestInfo['user_last_name'] ?? '',
            'user_email' => $guestInfo['email'] ?? $guestInfo['user_email'] ?? '',
